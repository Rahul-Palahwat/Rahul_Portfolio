    ...
    return (
        <div id="past-work">
                ...
                <div className='card'>
                    ...
                    <a href="https://drive.google.com/file/d/11m3w0ePmBKSA_zhnD5K71BYN_GF9DEKJ/view?usp=sharing" target='_blank'>OnBoarding Certificate <HiOutlineExternalLink/></a>
                </div>
                <div className='card'>
                    <img src={RealPensive} />
...
Created Store-front for shops where items are fetched from the database using API and then the items are displyed to the user with many functionality such as filter, best selling etc. User can create account using API and add item to cart and can checkout them.</li>
                    ...
                    <a href="https://drive.google.com/file/d/12CzesYbnM-sDA6H_vrY69KysYEOBUXJl/view?usp=sharing" target='_blank'>Completion Certificate <HiOutlineExternalLink/></a>
                </div>
                <div className='card'>
                    <img src={Fusion} />
                    <h3>Fusion IIIT</h3>
                    ...
                    <a href="https://docs.google.com/document/d/1ogEvoSJK5TDgSeX9Zmy7ggmKQfo3KSel/edit?usp=sharing&ouid=115597359274502264530&rtpof=true&sd=true" target='_blank'>Completion Certificate <HiOutlineExternalLink/></a>
                </div>
        </div>
    )
}
